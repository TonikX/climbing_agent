...
from app.schemas import (
    AttemptCreate, AttemptResponse, FinishTraining, TrainingCreate, TrainingResponse,
    UserResolveRequest, UserResponse,
)
from app.security import current_user_id, require_internal_key
from app.service import append_attempt, finish_training, list_trainings, resolve_user, start_training
